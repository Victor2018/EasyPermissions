...
class MainActivity : AppCompatActivity(),OnClickListener, EasyPermissions.PermissionCallbacks,
    ...
    private fun requestPermissionCamera() {
        if (hasCameraPermission()) {
            ...
            EasyPermissions.requestPermissions(
                this,
                getString(com.cherry.permissions.lib.R.string.permission_camera_rationale_message),
    ...
    private fun requestPermissionLocationAndContacts() {
        if (hasLocationAndContactsPermissions()) {
            ...
            EasyPermissions.requestPermissions(
                this,
                getString(com.cherry.permissions.lib.R.string.permission_location_and_contacts_rationale_message),
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == DEFAULT_SETTINGS_REQ_CODE) {
            val yes = getString(com.cherry.permissions.lib.R.string.yes)
            val no = getString(com.cherry.permissions.lib.R.string.no)

            // Do something after user returned from app settings screen, like showing a Toast.
            Toast.makeText(
                this,
                getString(
                    com.cherry.permissions.lib.R.string.returned_from_app_settings_to_activity,
    ...
    override fun onRationaleAccepted(requestCode: Int) {
        Log.d(TAG, getString(com.cherry.permissions.lib.R.string.log_permission_rationale_accepted, requestCode))
    }

    override fun onRationaleDenied(requestCode: Int) {
        Log.d(TAG, getString(com.cherry.permissions.lib.R.string.log_permission_rationale_denied, requestCode))
    }
}