 ...
 */
package com.cherry.permissions.lib.dialogs
...
import com.cherry.permissions.lib.R
...
class SettingsDialog(
    ...
    class Builder(private var context: Context) {
        ...
        var title = context.getString(R.string.title_settings_dialog,"Permissions")
        var rationale = context.getString(R.string.rationale_ask_again,"requested")
